...
/**
 * Mutation to update the number of views of a track
 */
const INCREMENT_TRACK_VIEWS = gql`
  mutation IncrementTrackViewResponseMutation($incrementTrackViewsId: ID!) {
...
const TrackCard = ({ track }) => {
  ...
  const [incrementTrackViews] = useMutation(INCREMENT_TRACK_VIEWS, {
    variables: { incrementTrackViewsId: id }, onCompleted: (data) => {
